...
def projects():
    Projects_Text = {
        'project1': '<strong class="header-name">TuffyHacks.com</strong><br>Product Manager<br><i> Lead the product efforts such as creating product specs, communicating with stakeholders, and working cross-functionally with a design, and engineering teams. The TuffyHacks Hacker portal allows hackers to learn more about TuffyHacks and have a positive hackathon experience. View <strong><a href="https://tuffyhacks.com">here</a></strong>.</i><br>',
        'project2': '<strong class="header-name">GP-Aide App </strong><br>Product Manager<br><i> In this project, I created product specs, managed the product sprint progress, and developed an iOS mobile application that allows users to calculate their semester grade point average. View <strong><a href="https://github.com/samuelsandoval1/223w-gp-aide">here</a></strong>.</i><br>',
        'project3': '<strong class="header-name">NiceBreakers </strong><br>Product Manager <br><i>Lead the product efforts to design product specs, design and develop this idea into an MVP. Nicebreakers provides space for individuals to play games and get to know more about each other. View <strong><a href="https://devpost.com/software/nicebreakers-8hwuoe">here</a></strong>.</i><br><br>',
